...
(function (root, factory) {
    ...
    describe("A chat room", function () {
        ...
        it("can be bookmarked", function () {
            ...
            spyOn(converse.connection, 'getUniqueId').andReturn('xxxx-xxxx-xxxx');
            ...
            expect(sent_stanza.toLocaleString()).toBe(
                "<iq type='set' from='dummy@localhost/resource' xmlns='jabber:client' id='xxxx-xxxx-xxxx'>"+
                    "<pubsub xmlns='http://jabber.org/protocol/pubsub'>"+
                        "<publish node='storage:bookmarks'>"+
                            "<item id='current'>"+
                                "<storage xmlns='storage:bookmarks'>"+
             ...
             */
            var stanza = $iq({'to': converse.connection.jid, 'type':'result', 'id':'xxxx-xxxx-xxxx'});
